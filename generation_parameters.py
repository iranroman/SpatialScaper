...
def get_params(argv="1"):
    ...
    params = dict(
        ...
        rirpath_sofa="/home/iran/SELD-data-generator/TAU_DB/TAU_SRIR_DB_SOFA",
        ...
        active_classes=[
            ...
            12,
            13,
        ],  # list of sound classes to be used for data generation
        classname_dict={
            "femaleSpeech": 0,
            "maleSpeech": 1,
            "clapping": 2,
        ...
        nb_mixtures_per_fold=[
            900,
            300,
        ],  # if scalar, same number of mixtures for each fold
        foldnames=["train", "test"],
        fs=44100,
        mixture_duration=60.0,  # in seconds
        event_time_per_layer=40.0,  # in seconds (should be less than mixture_duration)
